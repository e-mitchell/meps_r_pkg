...
# Helper function to download public use file from MEPS website.  Can save .ssp file to a
# permanent directory (dir).
...
# Extract data year based on the two-digit number in PERWT**F or WTDPER** (WTDPER** was converted
# to PERWT**F in 1999). The weight variable must be in the dataset.
...
# Extract event type based on most common two-character prefix for variable names on MEPS event
# datasets.
